...
const ACTIVITY_PROMPT = "¿Cómo va la participación? Dame el resumen de actividad de los participantes";
...
function init() {
  ...
  $("#btn-activity").addEventListener("click", () => { $("#prompt").value = ACTIVITY_PROMPT; send(); });
