...
`scripts/smoke_test.py` repite estas 15 comprobaciones y **se limpia solo**: cierra el registro, borra usuarios, preguntas y contadores de la prueba. Sirve de ensayo y de calentamiento unos minutos antes de la charla.
